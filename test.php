            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link" href="index.html">Recherche Video</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="index.html">Ps4</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="index.html">swicht</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="index.html">xbox</a>
                    </li>
                    <li class="nav-item">
